	    ...
	    IF(@QueryType=1)
	      BEGIN
			  ...
			  IF OBJECT_ID('tempdb..#TEMP2') IS NOT NULL DROP TABLE #TEMP2
			   ...
			   SELECT Top 1 a.*,b.JPCAId,b.JobPostId, b.FranchiseId,  b.RecruiterId, b.JPCAStatus,c.FranchiseName, d.Firstname + ' ' + d.Lastname as RecruiterName,  @QType  as QueryType  INTO #TEMP  
		   ...
		   IF( @JobPostId > 0) 
			 BEGIN
				  INSERT INTO #TEMP2 SELECT a.*,b.JPCAId,b.JobPostId, b.FranchiseId,b.RecruiterId,b.JPCAStatus,c.FranchiseName, d.Firstname + ' ' + d.Lastname as RecruiterName,  @QType  as QueryType  
			                         FROM CandidateDetail a INNER JOIN JobPostCandidateDetail b on (a.CandidateId=b.CandidateId)
									 INNER JOIN FranchiseDetail c ON (b.FranchiseId=c.FranchiseId)
			                         INNER JOIN UserDetail d on (b.RecruiterId=d.UserId)
